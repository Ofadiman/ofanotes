---
title: Mocking browser APIs in Jest
...
# Mocking browser APIs in Jest [2020-11-21]
...
The `navigator.permissions` read-only property returns an object that can be used to query and update permission status of APIs covered by the [Permissions API](https://developer.mozilla.org/en-US/docs/Web/API/Permissions_API).
