...
<MDXIntro>
  ...
  functions when instantiated with new, and allowing test-time configuration of
  return values.
</MDXIntro>
...
- [Mocking window.location methods in Jest & jsdom.](https://www.benmvp.com/blog/mocking-window-location-methods-jest-jsdom/)
